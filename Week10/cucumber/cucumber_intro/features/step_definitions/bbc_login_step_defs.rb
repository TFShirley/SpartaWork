...
Then("I will see an error for blank credentials") do
  expect(bbc_sign_in_page.find_username_error).to eq bbc_sign_in_page.blank_error
  expect(bbc_sign_in_page.find_password_error).to eq bbc_sign_in_page.blank_error
end
